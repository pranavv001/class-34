...
var blower
var emptyStar,oneStar,twoStar,starScore
...
function setup() 
{
  ...
  starsScore = createSprite(50,20)
  starsScore.addAnimation("empty",emptyStar)
  starsScore.addAnimation("one",oneStar)
  starsScore.addAnimation("two",twoStar)
  starsScore.scale = 0.2
...
function draw() 
{
  ...
  if (collide(fruit,star,40)=== true) {
    star.visible = false
    starsScore.changeAnimation("one")
  }

  if (collide(fruit,star2,40)=== true) {
    star2.visible = false
    starsScore.changeAnimation("two")
  }
...
function airBlow() {
  Matter.Body.applyForce(fruit,fruit.position,{x: 0,y:-0.03})
  air.play()
}
